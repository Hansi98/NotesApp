...
public class MainActivity extends AppCompatActivity
    ...
    protected void onResume() {
        ...
        //getSharedPreferences() is Inherited From Activity class
        ...
        if(name==null){
            ...
            TextView tvWelcome = findViewById(R.id.welcome_msg);
            tvWelcome.setText("Welcome "+name);
//            TextView tvName = drawer.getRootView().findViewById(R.id.tv_name);
//            tvName.setText(name);
